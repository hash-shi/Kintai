...
public class SrhMstKubunAction extends PJActionBase {
	public SrhMstKubunAction(HttpServletRequest req, HttpServletResponse res, IndexInformation info) {
		super(req, res, info);
	}
	...
	public void search(HttpServletRequest req, HttpServletResponse res) throws Exception {
        ...
        this.addContent("result",  PJActionBase.getMstKubuns(con, kbnCode, code, kbnName));
