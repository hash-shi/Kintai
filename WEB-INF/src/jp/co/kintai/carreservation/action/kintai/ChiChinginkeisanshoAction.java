...
public class ChiChinginkeisanshoAction extends PJActionBase {
	...
	public HashMap<String, String> searchShukeiArea(HttpServletRequest req, HttpServletResponse res, Connection con, String taishoYM, String taishoShainNo) throws Exception {
		...
		//日数
		sql.append("     ShinseiNissu01, ");		//勤務時間 ShinseiNissu01にはすでに「半休の勤務部分」が合計されている
		sql.append("     0 AS ShinseiNissu02, ");	//時間外勤務
		sql.append("     0 AS ShinseiNissu03, ");	//深夜勤務
		sql.append("     ShinseiNissu04, ");		//休日勤務
		sql.append("     ShinseiNissu05 + ShinseiNissu06 as ShinseiNissu05, ");		//有給休暇　半休を有休0.5日として計算するため、ShinseiNissu06(半休の休み部分)を足す
