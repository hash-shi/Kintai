...
public class CsvMstBushoDownload extends DownloadBase {
	
	public CsvMstBushoDownload(HttpServletRequest req, HttpServletResponse res, IndexInformation info) {
		super(req, res, info);
	}
	...
	public void doRun(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		csvStringTitle.addItem("部署区分",true);
		...
		for (int i = 0; i < data.size(); i++) {
			...
			csvStringRecord.addItem(d.get("BushoKbn"), PJActionBase.getQuotation(columns, "BushoKbn",d.get("BushoKbn")));
