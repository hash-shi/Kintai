...
public class CsvMstKubunDownload extends DownloadBase {
	...
	public void doRun(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		csvStringTitle.addItem("区分コード",true);
		csvStringTitle.addItem("コード",true);
		csvStringTitle.addItem("区分名称",true);
		csvStringTitle.addItem("区分略称",true);
		csvStringTitle.addItem("グループコード1",true);
		csvStringTitle.addItem("グループコード2",true);
