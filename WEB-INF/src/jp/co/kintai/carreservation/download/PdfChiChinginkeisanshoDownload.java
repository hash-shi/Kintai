...
public class PdfChiChinginkeisanshoDownload extends DownloadBase {
	...
	public void doRun(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		sql.append(" 	,CAST(K.ShinseiNissu01 AS VARCHAR) AS ShinseiNissu01 ");
		sql.append(" 	,CAST(K.ShinseiNissu02 AS VARCHAR) AS ShinseiNissu02 ");
		sql.append(" 	,CAST(K.ShinseiNissu03 AS VARCHAR) AS ShinseiNissu03 ");
		sql.append(" 	,CAST(K.ShinseiNissu04 AS VARCHAR) AS ShinseiNissu04 ");
		sql.append(" 	,CAST(K.ShinseiNissu05 + K.ShinseiNissu06 AS VARCHAR) AS ShinseiNissu05 "); // 半日有給0.5日
		sql.append(" 	,CAST(K.ShinseiNissu06 AS VARCHAR) AS ShinseiNissu06 ");
		sql.append(" 	,CAST(K.ShinseiNissu07 AS VARCHAR) AS ShinseiNissu07 ");
		sql.append(" 	,CAST(K.ShinseiNissu08 AS VARCHAR) AS ShinseiNissu08 ");
		sql.append(" 	,CAST(K.ShinseiNissu09 AS VARCHAR) AS ShinseiNissu09 ");
		sql.append(" 	,CAST(K.ShinseiNissu10 AS VARCHAR) AS ShinseiNissu10 ");
		sql.append(" 	,CAST(K.ShinseiNissu11 AS VARCHAR) AS ShinseiNissu11 ");
		...
		sql.append(" 		AND ");
		sql.append(" 			ChinginShinseiJikan3 = 0 ");
		sql.append(" 	) AS VARCHAR) AS ShinseiNisuuGoukei ");
