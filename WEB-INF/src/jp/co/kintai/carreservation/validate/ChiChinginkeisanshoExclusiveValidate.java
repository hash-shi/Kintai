...
public class ChiChinginkeisanshoExclusiveValidate extends ValidateBase {

	public ChiChinginkeisanshoExclusiveValidate(HttpServletRequest req, HttpServletResponse res, IndexInformation info) {
		super(req, res, info);
	}
