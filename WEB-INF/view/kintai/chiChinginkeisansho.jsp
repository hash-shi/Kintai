					...
					<tr>
						...
						<td class="value w300">
							<input type="text" class=""  style="width: 80px" name="txtShainNO" id="txtShainNO" value="<%=UtilEscape.htmlspecialchars(shainNO) %>" maxlength="4" onblur="getShainNOFormat();" 
								...
								<% } %>
							>
							<input type="hidden" name="hdnWkShainNO" id="hdnWkShainNO" value="<%=UtilEscape.htmlspecialchars(shainNO) %>">
							<input type="hidden" name="txtSearchedShainNO" id="txtSearchedShainNO" value="<%=UtilEscape.htmlspecialchars(shainNO) %>">
