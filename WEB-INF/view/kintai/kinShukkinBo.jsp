			...
			<div class="box">
				<table>
					<tr>
						...
						<td class="value w100">
							<input type="text" class=""  style="width: 80px; text-align: right;" name="srhTxtTaishoYM" id="srhTxtTaishoYM" value="<%=UtilEscape.htmlspecialchars(taishoYM) %>" maxlength="7" onblur="onChangeYM('srhTxtTaishoYM');" autofocus onfocus="this.setSelectionRange(7, 7),this.select()">
