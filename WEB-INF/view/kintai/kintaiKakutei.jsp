...
<main id="main-content" class="nom">
		...
		<div class="inputArea">
			...
			<table>
				<tr>
					...
					<td class="value w100">
						<input type="text" class=""  style="width: 80px; text-align: right;" name="srhTxtTaishoYM" id="srhTxtTaishoYM" onchange="onChangeYM('srhTxtTaishoYM')" value="<%=UtilEscape.htmlspecialchars(taishoDate) %>" maxlength="7"autofocus onfocus="this.setSelectionRange(7, 7),this.select()">
	...
	<div class="buttonArea right" id="buttonArea" style="visibility:hidden;">
	    <button type="button" onclick="onKakuteiKaijo();" data-focus="off">確定解除 [ F2 ] </button>
