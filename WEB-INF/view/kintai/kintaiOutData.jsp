		...
		<div class="inputArea">
			<table>
				<tr>
					...
					<td class="value">
						<input type="text" class="w60 right"  name="txtTaishoNengetsuF" id="txtTaishoNengetsuF" value="">
						-
						<input type="text" class="w60 right"  name="txtTaishoNengetsuT" id="txtTaishoNengetsuT" value="">
						(YYYY/MM)
					</td>
				</tr>
			</table>
