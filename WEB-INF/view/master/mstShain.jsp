		...
		<div class="inputArea">
			<table>
				<tr>
					...
					<td class="value w500">
						<input type="text" class="w80" maxlength="4" name="txtShainNO" id="txtShainNO"  value="" readonly>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="value w500">
						<input type="text" class="w80 right"  maxlength="4"  name="txtKeiyakuJitsudoJikan" id="txtKeiyakuJitsudoJikan"  value="0.00" >				
					</td>
				</tr>
				<tr>
