		...
		<div class="inputArea">
			<table>
				...
				<tr>
					...
					<td class="value w500">
						<input type="text" class="w80"  maxlength="2" name="txtShainKbn" id="txtShainKbn"  value=""  onblur="setSelectFromInput('txtShainKbn','selShainKbnName'); updateActiveSwitch()" >
						<select class="w90" name="selShainKbnName" id="selShainKbnName" onchange="setInputFromSelect('selShainKbnName','txtShainKbn'); updateActiveSwitch()">
						<option value=""> </option>
				...
				<tr>
					...
					<td class="value w500">
						<input type="text" class="w80"  maxlength="2" name="txtShukinboKbn" id="txtShukinboKbn"  value=""  onblur="setSelectFromInput('txtShukinboKbn','selShukinboKbnName'); updateActiveSwitch();" >
						<select class="w90" name="selShukinboKbnName" id="selShukinboKbnName" onchange="setInputFromSelect('selShukinboKbnName','txtShukinboKbn'); updateActiveSwitch();" >
						<option value=""> </option>
				...
				<tr>
					...
					<td class="value w500">
						...
						<img class="img border" src="./images/search.png" onclick="opnDialog('srhMstEigyosho','txtEigyoshoCode','txtEigyoshoName'); return false;">
				...
				<tr>
					...
					<td class="value w500">
						...
						<img class="img border" src="./images/search.png" onclick="opnDialog('srhMstBusho','txtBushoCode','txtBushoName'); return false;">
				...
				<tr>
					...
					<td class="value w500">
						<input type="text" class="w80" maxlength="2" name="txtJikyuNikkyuKbn" id="txtJikyuNikkyuKbn"  value=""  onblur="setSelectFromInput('txtJikyuNikkyuKbn','selJikyuNikkyuKbnName');" >
						<select class="w50" name="selJikyuNikkyuKbnName" id="selJikyuNikkyuKbnName" onchange="setInputFromSelect('selJikyuNikkyuKbnName','txtJikyuNikkyuKbn');" >
						<option value=""> </option>
				...
				<tr>
					...
					<td class="value w500">
						...
						<input type="hidden" class="" name="txtKinmuKaishiJiKbn" id="txtKinmuKaishiJiKbn" value="" onchange="getKubunName('hdnKinmuKaishiJi', 'txtKinmuKaishiJiKbn', 'txtKinmuKaishiJiKbnName');">
						<input type="hidden" class="" name="txtKinmuKaishiJiKbnName" id="txtKinmuKaishiJiKbnName" value="">
						<select class="w50" name="selKinmuKaishiJiKbnName" id="selKinmuKaishiJiKbnName" onchange="setInputFromSelect('selKinmuKaishiJiKbnName','txtKinmuKaishiJiKbn');">
						<option value=""> </option>
						...
						<input type="hidden" class="" name="txtKinmuKaishiFunKbn" id="txtKinmuKaishiFunKbn" value="" onchange="getKubunName('hdnKinmuKaishiFun', 'txtKinmuKaishiFunKbn', 'txtKinmuKaishiFunKbnName');">
						<input type="hidden" class="" name="txtKinmuKaishiFunKbnName" id="txtKinmuKaishiFunKbnName" value="">
						<select class="w50" name="selKinmuKaishiFunKbnName" id="selKinmuKaishiFunKbnName" onchange="setInputFromSelect('selKinmuKaishiFunKbnName','txtKinmuKaishiFunKbn');">
						<option value=""> </option>
				...
				<tr>
					...
					<td class="value w500">
						...
						<input type="hidden" class="" name="txtKinmuShuryoFunKbn" id="txtKinmuShuryoFunKbn" value="" onchange="getKubunName('hdnKinmuShuryoFun', 'txtKinmuShuryoFunKbn', 'txtKinmuShuryoFunKbnName');">
						<input type="hidden" class="" name="txtKinmuShuryoFunKbnName" id="txtKinmuShuryoFunKbnName" value="">
						<select class="w50" name="selKinmuShuryoFunKbnName" id="selKinmuShuryoFunKbnName" onchange="setInputFromSelect('selKinmuShuryoFunKbnName','txtKinmuShuryoFunKbn');">
						<option value=""> </option>
							<% for (int count = 0 ; count < mstKubun0053.size() ; count++){ HashMap<String, String> record = mstKubun0053.get(count);%>
								<option value="<%=UtilEscape.htmlspecialchars(record.get("Code")) %>"><%=UtilEscape.htmlspecialchars(record.get("KbnName")) %></option>
							<% } %>
				...
				<tr>
					...
					<td class="value w500">
						<input type="text" class="w80" maxlength="2" name="txtTsukinHiKbn" id="txtTsukinHiKbn"  value="" onblur="setSelectFromInput('txtTsukinHiKbn','selTsukinHiKbnName');" >
						<select class="w50" name="selTsukinHiKbnName" id="selTsukinHiKbnName" onchange="setInputFromSelect('selTsukinHiKbnName','txtTsukinHiKbn');" >
						<option value=""> </option>
				...
				<tr>
					...
					<td class="value w500">
						<input type="text" class="w80"  maxlength="10"  name="txtTaisyokuDate" id="txtTaisyokuDate"  value="" >
						(YYYY/MM/DD)
					</td>
				</tr>
			</table>
