...
JKL.Calendar.prototype.setDaySelectCallback = function(daySelectCallback){ this.__daySelectCallback = daySelectCallback; }
...
JKL.Calendar.prototype.initDate = function ( dd ) {
    ...
    this.getFormValue();
    this.date = new Date( this.__prevY, this.__prevM, this.__prevD );
    return this.date;
}
...
// カレンダーと全く同じサイズのIFRAMEを生成し、座標を一致させて下位レイヤに描画する
    ...
    var day_onclick = function (ev) {
        ...
        __this.fadeOut( 1.0 );
        if (__this.__daySelectCallback != null){
        	__this.__daySelectCallback(srcday);
        }
    };
