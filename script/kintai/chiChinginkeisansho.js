...
function onDisplayNyuryokuArea(firstHalfFlg){
	...
	for(let i = 0; i < chiChinginkeisanshoResultAll.length; i++){
		...
		sinsei1SelectBox += 	"<select name=\"selChinginShinseiKbn1" + i + "\" id=\"selChinginShinseiKbn1" + i + "\" value=\"" + chinginShinseiKbn1 + "\"  onchange=\"setShukkinBo('selChinginShinseiKbn1', " + i + ");resetJikan('1', " + i + "); selKyuShutsu( '1'," + i +");\" >" ;
		...
		sinsei2SelectBox += 	"<select name=\"selChinginShinseiKbn2" + i + "\" id=\"selChinginShinseiKbn2" + i + "\" value=\"" + chinginShinseiKbn2 + "\"  onchange=\"setShukkinBo('selChinginShinseiKbn2', " + i + ");resetJikan('2', " + i + "); selKyuShutsu( '2'," + i +");\" >" ;
		...
		sinsei3SelectBox += 	"<select name=\"selChinginShinseiKbn3" + i + "\" id=\"selChinginShinseiKbn3" + i + "\" value=\"" + chinginShinseiKbn3 + "\"  onchange=\"setShukkinBo('selChinginShinseiKbn3', " + i + ");resetJikan('3', " + i + "); selKyuShutsu( '3'," + i +");\" >" ;
			...
			kihonNyuryokuAreaHtml =
				"<tr>" +
					...
					"<td class=\"value center\">" + 
						"<input type=\"tel\" class=\"\"  style=\"width: 40px; text-align: right;\" maxlength=\"2\" name=\"numShusshaJi" + i + "\" id=\"numShusshaJi" + i + "\"  value=\"" + shusshaJi + "\"  onchange=\"set2ketaFormat('numShusshaJi', " + i + ");changeShusshaJi(" + i + ");setShukkinBo('numShusshaJi', " + i + ");calcJitsudoJikan(" + i + ");\" >" + 
					"</td>" +
					"<td class=\"value center\">" + 
						"<input type=\"tel\" class=\"\"  style=\"width: 40px; text-align: right;\" maxlength=\"2\" name=\"numShusshaFun" + i + "\" id=\"numShusshaFun" + i + "\"  value=\"" + shusshaFun + "\"  onchange=\"set2ketaFormat('numShusshaFun', " + i + ");setShukkinBo('numShusshaFun', " + i + ");calcJitsudoJikan(" + i + ");\" >" + 
					"</td>" +
					"<td class=\"value center\">" + 
						"<a >-</a>" + 
					"</td>" +
					"<td class=\"value center\">" + 
						"<input type=\"tel\" class=\"\"  style=\"width: 40px; text-align: right;\" maxlength=\"2\" name=\"numTaishaJi" + i + "\" id=\"numTaishaJi" + i + "\"  value=\"" + taishaJi + "\"  onchange=\"set2ketaFormat('numTaishaJi', " + i + ");setShukkinBo('numTaishaJi', " + i + ");calcJitsudoJikan(" + i + ");\" >" + 
					"</td>" +
					"<td class=\"value center\">" + 
						"<input type=\"tel\" class=\"\"  style=\"width: 40px; text-align: right;\" maxlength=\"2\" name=\"numTaishaFun" + i + "\" id=\"numTaishaFun" + i + "\"  value=\"" + taishaFun + "\"  onchange=\"set2ketaFormat('numTaishaFun', " + i + ");setShukkinBo('numTaishaFun', " + i + ");calcJitsudoJikan(" + i + ");\" >" + 
					"</td>" +
					"<td class=\"value center\">" + 
						"<input type=\"tel\" class=\"\"  style=\"width: 40px; text-align: right;\" maxlength=\"5\" name=\"numJitsudoJikan" + i + "\" id=\"numJitsudoJikan" + i + "\"  value=\"" + jitsudoJikan + "\"  onchange=\"setDecimalPoint2ketaFormat('numJitsudoJikan', " + i + ");setShukkinBo('numJitsudoJikan', " + i + ");\" >" + 
					"</td>" +
					"<td class=\"value center\">" + 
						sinsei1SelectBox + 
					"</td>" +
					"<td class=\"value center\">" + 
						"<input type=\"tel\" class=\"\"  style=\"width: 40px; text-align: right;\" maxlength=\"5\" name=\"numChinginShinseiJikan1" + i + "\" id=\"numChinginShinseiJikan1" + i + "\"  value=\"" + chinginShinseiJikan1 + "\"  onchange=\"setDecimalPoint2ketaFormat('numChinginShinseiJikan1', " + i + ");setShukkinBo('numChinginShinseiJikan1', " + i + ");\" >" + 
					"</td>" +
					"<td class=\"value center\">" + 
						sinsei2SelectBox + 
					"</td>" +
					"<td class=\"value center\">" + 
						"<input type=\"tel\" class=\"\"  style=\"width: 40px; text-align: right;\" maxlength=\"5\" name=\"numChinginShinseiJikan2" + i + "\" id=\"numChinginShinseiJikan2" + i + "\"  value=\"" + chinginShinseiJikan2 + "\"  onchange=\"setDecimalPoint2ketaFormat('numChinginShinseiJikan2', " + i + ");setShukkinBo('numChinginShinseiJikan2', " + i + ");\" >" + 
					"</td>" +
					"<td class=\"value center\">" + 
						sinsei3SelectBox + 
					"</td>" +
					"<td class=\"value center\">" + 
						"<input type=\"tel\" class=\"\"  style=\"width: 40px; text-align: right;\" maxlength=\"5\" name=\"numChinginShinseiJikan3" + i + "\" id=\"numChinginShinseiJikan3" + i + "\"  value=\"" + chinginShinseiJikan3 + "\"  onchange=\"setDecimalPoint2ketaFormat('numChinginShinseiJikan3', " + i + ");setShukkinBo('numChinginShinseiJikan3', " + i + ");\" >" + 
					"</td>" +
				"</tr>";
		}
		else{
...
*
*/
function selKyuShutsu(nowCol,nowRow){
	let fieldName = "selChinginShinseiKbn" + nowCol;
	...
	if($("#" + fieldName + nowRow).val() == "04"){
		...
		if($("#" + fieldName + nowRow).val() != "0.00"){
			...
			chiChinginkeisanshoResultAll[nowRow]["numChinginShinseiJikan"+ nowCol] = jikan
			$("#numChinginShinseiJikan" + nowCol + nowRow).val(jikan);
